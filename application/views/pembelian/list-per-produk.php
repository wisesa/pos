    ...
    <div class="container">
        ...
        <?php 
            ...
            <tr>
                ...
                <td><button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo base_url() ?>pembelian/index/<?php echo $row->id_produk ?>';">Lihat Detail</button></td>
            </tr>
        <?php } ?>
        </tbody>
    </div>
